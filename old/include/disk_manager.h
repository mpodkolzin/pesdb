...
class DiskManager {
 public:
   ...
   *
   * Note: Page is NOT initialized! Caller must call WritePage() to actually
   * allocate disk space and write data.
   *
   ...
   * This includes allocated-but-not-yet-written pages.
   */
 ...
 private:
  ...
  size_t num_pages_;          ///< Total pages (both on-disk and allocated)
};
