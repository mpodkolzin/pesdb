...
// ============================================================================
// AllocatePage: Reserve Next Page ID
// ============================================================================
...
page_id_t DiskManager::AllocatePage() {
  ...
  // Increment count (reserves the page)
  num_pages_++;

  // Note: Page is NOT initialized here!
  // File grows lazily when WritePage() is called.
  // This is simpler than eagerly zero-initializing.
